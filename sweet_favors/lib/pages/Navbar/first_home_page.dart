              ...
              builder: (context, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                 ...
                 if (wishlists.isEmpty) {
                   return Center(child: const Text('You don\'t have a wish yet.', textAlign: TextAlign.center, style: TextStyle(fontSize: 16),));
                 } else {
                   return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return CardWidget(
                        ...
                        username: username, // Access from the surrounding scope
